Yo armaría un análisis exploratorio/gráficos muy general de entender la data pero orientado un poco a lo que queremos ver:

- Distribución de variables que van a ser interesantes para modelo tipo VAEP (Distribución acciones en X, en Y de los pases, tiempos entre acciones, etc)
